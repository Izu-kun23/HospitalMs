...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            const token = aToken; // Assuming `aToken` is the admin token from context
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Branch</p>
                            <input onChange={e => setBranchName(e.target.value)} value={branchName} className='border rounded px-3 py-2' type="text" placeholder='Branch Name' required />
                            <input onChange={e => setBranchLocation(e.target.value)} value={branchLocation} className='border rounded px-3 py-2' type="text" placeholder='Branch Location' required />
                        </div>
